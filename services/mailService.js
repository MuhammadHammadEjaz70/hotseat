...
async function sendAttachmentsEmail(to, subject, text, attachments) {
	var transport = createTransport();
	var transportVerify = await verifyTransport(transport);
	await transport.sendMail({
		from: process.env.MAIL_EMAIL, // Your email address
		to: to,
		subject: subject,
		text: text,
...
module.exports = { sendEmail, sendAttachmentsEmail };
